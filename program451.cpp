...
int main()
{
    ...
    obj.InsertFirst(90.323556);
    obj.InsertFirst(20.3654);
    obj.InsertFirst(30.254565);

    obj.Display();
    iRet = obj.Count();
    cout<<"Number of elemensts are : "<<iRet<<endl;

    obj.InsertLast(25.0236555);
    obj.InsertLast(45.2355);
    obj.InsertLast(5632.235);
    
    obj.Display();
    iRet = obj.Count();
    cout<<"Number of elemensts are : "<<iRet<<endl;

    obj.InsertAtPos(123.025568,5);
